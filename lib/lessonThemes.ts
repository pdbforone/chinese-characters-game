...
const lessonThemes: Record<number, LessonTheme> = {
  ...
  // Lesson 16: The Iron Burglar - Iron City, metallic heist, industrial
  16: {
    lessonId: 16,
    name: 'Iron City',
    bgGradient: 'from-zinc-950 via-slate-900 to-stone-950',
    cardBg: 'bg-zinc-900/60',
    cardBorder: 'border-zinc-700/50',
    textPrimary: 'text-zinc-100',
    textSecondary: 'text-zinc-300',
    textMuted: 'text-zinc-400',
    accentPrimary: 'from-zinc-500 to-slate-500',
    accentSecondary: 'from-zinc-600 to-slate-600',
    headerBg: 'bg-zinc-900/80',
    headerText: 'text-zinc-100',
    streakBg: 'bg-slate-500/20 border-slate-500/50',
    streakText: 'text-slate-400',
  },

  // Lesson 17: The Political Footstep - Political labyrinth, bureaucracy
  17: {
    lessonId: 17,
    name: 'Political Labyrinth',
    bgGradient: 'from-slate-950 via-blue-950 to-gray-950',
    cardBg: 'bg-slate-900/60',
    cardBorder: 'border-blue-900/50',
    textPrimary: 'text-slate-100',
    textSecondary: 'text-blue-200',
    textMuted: 'text-blue-300/70',
    accentPrimary: 'from-blue-600 to-slate-600',
    accentSecondary: 'from-blue-700 to-slate-700',
    headerBg: 'bg-slate-900/80',
    headerText: 'text-blue-100',
    streakBg: 'bg-blue-500/20 border-blue-500/50',
    streakText: 'text-blue-400',
  },

  // Lesson 18: The Day the Sky Wore Clothes - Sky tailor, weather, fabric
  18: {
    lessonId: 18,
    name: 'Sky Tailor Workshop',
    bgGradient: 'from-sky-950 via-indigo-950 to-violet-950',
    cardBg: 'bg-sky-950/50',
    cardBorder: 'border-sky-800/50',
    textPrimary: 'text-sky-50',
    textSecondary: 'text-sky-200',
    textMuted: 'text-sky-300/70',
    accentPrimary: 'from-sky-500 to-indigo-500',
    accentSecondary: 'from-sky-600 to-indigo-600',
    headerBg: 'bg-sky-950/80',
    headerText: 'text-sky-100',
    streakBg: 'bg-indigo-500/20 border-indigo-500/50',
    streakText: 'text-indigo-400',
  },

  // Lesson 19: The Mirror of Absurdity - Sound mirror temple, reflections
  19: {
    lessonId: 19,
    name: 'Sound Mirror Temple',
    ...
    accentPrimary: 'from-purple-500 to-fuchsia-500',
    accentSecondary: 'from-purple-600 to-fuchsia-600',
  ...
  // Lesson 20: The Snake's Egg Breakfast - Serpent's pond, nature morning
  20: {
    lessonId: 20,
    name: "Serpent's Pond",
    bgGradient: 'from-green-950 via-lime-950 to-emerald-950',
    cardBg: 'bg-green-950/50',
    cardBorder: 'border-green-800/50',
    textPrimary: 'text-green-50',
    textSecondary: 'text-green-200',
    textMuted: 'text-green-300/70',
    accentPrimary: 'from-green-500 to-lime-500',
    accentSecondary: 'from-green-600 to-lime-600',
  ...
  // Lesson 21: The Factory of Forgetfulness - Forgetting factory, dreamlike
  21: {
    lessonId: 21,
    name: 'Forgetting Factory',
    bgGradient: 'from-gray-950 via-neutral-900 to-stone-950',
    cardBg: 'bg-gray-900/60',
    cardBorder: 'border-gray-700/50',
    textPrimary: 'text-gray-100',
    textSecondary: 'text-gray-300',
    textMuted: 'text-gray-400',
    accentPrimary: 'from-gray-500 to-neutral-500',
    accentSecondary: 'from-gray-600 to-neutral-600',
    headerBg: 'bg-gray-900/80',
    headerText: 'text-gray-100',
    streakBg: 'bg-neutral-500/20 border-neutral-500/50',
    streakText: 'text-neutral-400',
  },
};
